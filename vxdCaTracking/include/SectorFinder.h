...
#ifndef SECTORFINDER_H
#define SECTORFINDER_H
	...
	namespace Tracking {
		...
		*/
		...
		public:
			...
			SectorFinder(int clusterIndex, int ownIndex, bool isPXD):
		...
		protected:
			...
			boost::array<float, numFilters> nameVector; /**< array storing all the strings where the enums can be used to access their position */
